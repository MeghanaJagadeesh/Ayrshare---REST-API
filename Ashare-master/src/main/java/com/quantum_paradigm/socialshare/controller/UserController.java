...
public class UserController {
	...
	public ResponseEntity<PackageResponse> userRemainingDays(@RequestParam String userId) {
		System.out.println(userId);
		return userTracking.calculateRemainingPackageDays(userId);
	}

	@GetMapping("/verify")
	public ResponseEntity<ResponseStructure<String>> verifyEmail(@RequestParam("token") String token) {
		System.out.println("verification method");
